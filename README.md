...
```bash
wget https://github.com/hudsonalbuquerque97-sys/ut2003-installer/raw/main/UT2003_installer_Online_Linux.sh && chmod +x UT2003_installer_Online_Linux.sh && ./UT2003_installer_Online_Linux.sh
```
...
```bash
wget https://github.com/hudsonalbuquerque97-sys/ut2003-installer/raw/main/UT2003_installer_Online_Linux.sh
```
